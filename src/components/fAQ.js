  ...
  render() {
    return (
      <>
        ...
        <Answer
          answer="Yes. It is very dependent on the needs, but a responsive, simple, static website with social media links and basic company information displayed can go for as little as $60.
        If you want hosting configuration on top of that, which you probably do, you will have to pay much more, around $30 for me setting it up. On the other hand, a website which fetches, uses and displays data from a database or APIs (customer login, stores, 3rd party integrations), will be much more expensive, with almost no limit. In general it is more or less costly for you dependent on how complex the functionality of your website is. I have these very low prices for websites in for a limited time, as my business grows and I evolve as a web developer the websites will become more expensive."
        />
        <BasicButton>
