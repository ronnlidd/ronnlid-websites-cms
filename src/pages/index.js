...
import AsideContentIndexPage from "../components/asideContent.js"
          ...
          <>
            ...
            <AboutDavid className="aboutDavid" id="about">
              ...
              <p>
                ...
                old, web developer (mainly front-end) & entrepreneur. My vision
                is no less than a world where people are experiencing more
                well-being. I try to boost love and reduce suffering by accruing
                power to influence reality, including the society within which
                the people who can experience more or less valuably exist. This
                company & coding is a means to that end.
              </p>
            </AboutDavid>
          </>
        }
      >
        <AsideContentIndexPage />
