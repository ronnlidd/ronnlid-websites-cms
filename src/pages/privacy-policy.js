    ...
    return (
      <Layout pageTitle="Privacy Policy">
        <SEO
          ...
          desciption="This is the privacy policy for David Rönnlid & Ronnlid Websites, everything regarding legal questions can be found here and in our terms of service."
        />
        <p>
          Our Privacy Policy was last updated and posted on March 7, 2019. It
          ...
          operated by David Rönnlid. Any capitalized terms not defined in our
          Privacy Policy, have the meaning as specified in our Terms of Service.
        </p>
        <p>
          ...
          communicate and disclose and make use of personal information. We use
          your Personal Information only for providing and improving the
          website. By using the website, you agree to the collection and use of
          ...
          https://ronnlidwebsites.com. The following outlines our privacy
          policy.
        </p>
        ...
        <p>
          ...
          <br />
          David Rönnlid follows all legal requirements to protect your privacy.
          ...
          services. David Rönnlid may also utilize your Personal Data and
          ...
          the Website, to much better comprehend our users, and to improve our
        ...
        <p>
          ...
          information that is shared between you and others.
        </p>
        <p>
        ...
        <p>
          Under the Child's Online Privacy Security Act, no Website operator can
          require, as a condition to involvement in an activity, that a child
          younger than 13 years of age divulge more details than is reasonably
          required. David Rönnlid abides by this demand. David Rönnlid just
          collects information willingly offered; no information is gathered
          passively. children under 13 can submit only their email address when
          sending us an email in our "Contact Us" area. David Rönnlid makes use
          of the email address to respond to a one-time demand from a child
          under 13 and afterwards deletes the email address. In case David
          Rönnlid collects and maintains personal information relating to a
          child under 13, the parent may send out an email to us to review,
          alter and/or erase such info as well as to decline to enable any
        ...
        <ul style={{ color: "white" }}>
          ...
          <li>
            <p>
              ...
              property, or personal safety of David Rönnlid, our Users,
        ...
        <p>
          ...
          you for this detail. When you register for the website, if you do not
          want to receive any additional material or notifications from us, you
          can show your preference on our registration form.
        </p>
        <p>
